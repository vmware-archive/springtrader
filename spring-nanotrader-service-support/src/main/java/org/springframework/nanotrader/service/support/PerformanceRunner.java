...
public class PerformanceRunner implements Runnable {
	...
	PerformanceRunner(String numUsers, String db, String vmName, String vmUser, String vmPwd, String serverUrl) {
		this.vmName = vmName;
		this.vmUser = vmUser;
		this.vmPwd = vmPwd;
	...
	private void exec(String command) throws IOException {
	    ...
	    try {
	      ...
	      if (cmd.getExitStatus() != 0) {
	        System.out.println("Command [" + command + "] failed with exit status :" +cmd.getExitStatus()+ " on "+vmName);
