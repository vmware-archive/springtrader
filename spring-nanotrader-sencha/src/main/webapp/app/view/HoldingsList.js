Ext.define('SpringTrader.view.HoldingsList', {
    ...
    config: {
        ...
        itemTpl: '<table><tr><td width="15%">{symbol}</td><td width="20%" class="right">{price}</td><td width="35%" class="right">{value}</td><td width="30%" class="right {[ values.isgain ? "green-color" : "red-color" ]}">{netgain}</td></tr></table>',
        plugins: [{
