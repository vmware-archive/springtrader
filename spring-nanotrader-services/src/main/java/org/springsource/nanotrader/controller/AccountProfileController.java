...
public class AccountProfileController {
	private static Logger log = LoggerFactory.getLogger(AccountProfileController.class);
	...
	@ResponseBody
	public Accountprofile find(@PathVariable( "id" ) final Integer id ) throws NoRecordsFoundException {
		...
		if (log.isDebugEnabled()) { 
			log.debug("AccountProfileController.find - after service call. Payload is: " + accountProfileResponse);
		}
	...
	public void save(@RequestBody Accountprofile accountProfileRequest) {
		if (log.isDebugEnabled()) { 
			log.debug("AccountProfileController.save:" + accountProfileRequest.toString());
		}
	...
	public void update(@RequestBody Accountprofile accountProfileRequest) {
		if (log.isDebugEnabled()) { 
			log.debug("AccountProfileController.update:" + accountProfileRequest.toString());
		}
		org.springframework.nanotrader.domain.Accountprofile accountProfile = new org.springframework.nanotrader.domain.Accountprofile();
		mapper.map(accountProfileRequest, accountProfile);
