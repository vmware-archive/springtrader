                    ...
                    <div class="row">
						<div class="span4">
	                        <div id="fullname-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="text" value="" id="fullname-input" class="span4 focused"><br/>
	                        ...
	                        <div id="email-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="text" value="" id="email-input" class="span4 focused"><br/>
	                        ...
	                        <div id="password-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="password" value="" id="reg-password-input" class="span4 focused"><br/>
	                        ...
	                        <div id="matchpasswd-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="password" id="matchpasswd-input" class="span4 focused"><br/>
	                    ...
	                    <div class="span4">
	                        <div id="username-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="text" value="" id="reg-username-input" class="span4 focused"><br/>
	                        ...
	                        <div id="openbalance-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="number" value="" id="openbalance-input" class="span4 focused"><br/>
	                        ...
	                        <div id="creditcard-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="text" readonly="" value="1234123412341234" id="creditcard-input" class="span4 focused" maxlength="16"><br/>
	                        ...
	                        <div id="address-control" class="control-group">
	                            ...
	                            <div class="controls">
	                                <input type="text" value="" id="address-input" class="span4 focused"><br/>
