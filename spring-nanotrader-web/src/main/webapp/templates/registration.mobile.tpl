...
<div class="row clearfix">
                ...
                <fieldset>
                    ...
                    <div class="span4">
                        ...
                        <div id="address-control" class="control-group">
                            ...
                            <div class="controls">
                                <textarea rows="3" id="address-input" class="input-xlarge"></textarea><br/>
        ...
        <div class="span2 columns sidebar">
            ...
            <div class="pagination-right"><a id="showLoginBtn" class="btn btn-inverse"><%= translate("loginPage") %></a></div>
        </div>
    </div>
</div>
