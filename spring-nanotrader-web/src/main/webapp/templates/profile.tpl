<div class="span9 columns">
    <form class="form-horizontal">
        <fieldset>
            ...
            <div class="row">
				<div class="span4">
	                <div id="fullname-control" class="control-group">
	                    ...
	                    <div class="controls">
	                        <input type="text" value="<%= fullname %>" id="fullname-input" class="span4 focused" maxlength="100"><br/>
	                ...
	                <div id="username-control" class="control-group">
	                    ...
	                    <div class="controls">
	                        <input type="text" value="<%= userid %>" id="username-input" class="span4 focused" maxlength="100"><br/>
	                ...
	                <div id="password-control" class="control-group">
	                    ...
	                    <div class="controls">
	                        <input type="password" value="<%=passwd %>" id="password-input" class="span4 focused" maxlength="20"><br/>
	                ...
	                <div id="matchpasswd-control" class="control-group">
	                    ...
	                    <div class="controls">
	                        <input type="password" value="<%=passwd %>" id="matchpasswd-input" class="span4 focused" maxlength="20"><br/>
	            ...
	            <div class="span4">
	                <div id="email-control" class="control-group">
	                    ...
	                    <div class="controls">
	                        <input type="text" value="<%= email %>" id="email-input" class="span4 focused" maxlength="100"><br/>
	                ...
	                <div id="creditcard-control" class="control-group">
	                    ...
	                    <div class="controls">
	                        <input type="text" value="<%= creditcard %>" id="creditcard-input" class="span4 focused" maxlength="16"><br/>
	                ...
	                <div id="address-control" class="control-group">
	                    ...
	                    <div class="controls">
	                        <textarea rows="3" id="address-input" class="span4" maxlength="250"><%= address %></textarea><br/>
            ...
            <div class="row">
				<div class="form-actions offset4 span4 ">
