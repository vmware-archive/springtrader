            ...
            <fieldset>
                ...
                <div class="span4">
                    <div id="fullname-control" class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<%= fullname %>" id="fullname-input" class="input-xlarge focused" maxlength="100"><br/>
                    ...
                    <div id="username-control" class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<%= userid %>" id="username-input" class="input-xlarge focused" maxlength="100"><br/>
                ...
                <div class="span4">
                    <div id="email-control" class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<%= email %>" id="email-input" class="input-xlarge focused" maxlength="100"><br/>
                    ...
                    <div id="creditcard-control" class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<%= creditcard %>" id="creditcard-input" class="input-xlarge focused" maxlength="16"><br/>
                    ...
                    <div id="address-control" class="control-group">
                        ...
                        <div class="controls">
                            <textarea rows="3" id="address-input" class="input-xlarge" maxlength="250"><%= address %></textarea><br/>
